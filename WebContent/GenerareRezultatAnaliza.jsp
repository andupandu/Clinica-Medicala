...
<div class="jumbotron">
  <h2 class="display-4" align="center">Rezultate analize</h2>
  <hr class="my-4">
...
<form method="get" action="CreazaPDFRezultatAnaliza" style="margin:0 auto" id="descarca">
Cod buletin analiza:<input type="text" name="buletin" id="buletin" class=" form-control" >
<br><input type="button" class="btn btn-secondary" id="creaza" name="creaza" value="Descarca rezultat">
       </form>
    </div>
</section>
</div>
