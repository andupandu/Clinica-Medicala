  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <a href="GenerareRezultatAnaliza.jsp" class="dropdown-item">Rezultate analize</a>
       <a href="Login.jsp" class="dropdown-item">Gama de analize</a>
        </div>
      </li>
         <li class="nav-item dropdown">
...
<img src="resources/medical.png" width="500" height="400" class="center">
  <h3 class="display-4" align="center"><img src="resources/user-md.svg" width="60" height="60" class=" rounded-circle center"><%=request.getParameter("nume") %></h3>
  <hr class="my-4">
  <section class="container p-t-3">
    <div class="row">
        <div class="col-lg-12">
   <h4 align="center">  Specialitate:<%=spec %></h4>
      <div id="accordion">
  <div class="card">
  ...
  <tbody>
  <% int i=0;
  List<ProgramLucru> program=DbOperations.getProgramMedic(cod);
  List<Serviciu> servicii=DbOperations.getServiciiMedic(cod);
  for(ProgramLucru p:program){ %>
    <tr>
    
      <td><%=p.getZi() %></td>
      <td><%=p.getOraInceput()+"-"+p.getOraSfarsit() %></td>
  ...
  for(Serviciu serv:servicii){ %>
    <tr>
      ...
      <td><%=serv.getDenumire() %></td>
      <td><%=serv.getPret() %> Lei</td>
